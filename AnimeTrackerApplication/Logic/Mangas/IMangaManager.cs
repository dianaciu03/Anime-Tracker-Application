...
namespace Logic.Mangas
{
    public interface IMangaManager
    {
        ...
        int GetNrManga();
        void UpdateManga(int id, string name, string creator, int nrChapters, int releaseYear, MangaStatus status, decimal rating, string description, string imageURL);
    }
}